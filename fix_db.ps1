...
$connectionString = "Server=localhost;Database=ungdungmangxahoiv_2;Trusted_Connection=true;TrustServerCertificate=true;"
...
try {
    ...
    Write-Host "Error fixing database: $($_.Exception.Message)" -ForegroundColor Red
}
